    ...
    <div style={{
      ...
      <span style={{ fontSize: 12.5, color: TH.inkSoft }}>
        {names
          ...
          : <>Written to our <Link href="/methodology" style={{ color: TH.sageDeep, textDecoration: "none", fontWeight: 600 }}>evidence methodology</Link> · reviewed against published research</>}
      </span>
