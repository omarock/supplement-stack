...
const ENTRIES: Entry[] = [
  ...
  },
  {
    ...
    body: "On the build page, you can now describe your goals in plain English ('I want better sleep and more energy') and Claude composes a stack instantly from our 151-ingredient catalog.",
  ...
  },
  {
    ...
    body: "Build your own stack from 151 ingredients. Live daily-ritual timeline, wellness preview, interaction warnings, share URL, and one-click iHerb checkout.",
    link: { label: "Open builder", href: "/build" },
  },
  {
    date: "2026-05-26",
    kind: "Improvement",
    title: "151 ingredients (up from 100)",
