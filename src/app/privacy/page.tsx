...
export default function Page() {
  return (
    <LegalPage eyebrow="Legal" title="Privacy Policy" lastUpdated="May 2026">
      ...
      <h2>5. Your Rights</h2>
      <p>
        You can clear all data Phyla has stored in your browser at any time by clearing your browser&apos;s localStorage (Settings → Site Data → Clear). For any data we hold on our servers (e.g. contact emails), you may request access, correction, or deletion by emailing <a href="mailto:hello@phyla.studio">hello@phyla.studio</a>.
      </p>

      <h2>6. Children</h2>
      <p>
        Phyla is not intended for children under 13. We do not knowingly collect data from anyone under 13. If you believe a child has used our service, contact us and we will remove the data.
      </p>
      ...
      <h2>8. Contact</h2>
      <p>
        Privacy questions: <a href="mailto:hello@phyla.studio">hello@phyla.studio</a>
      </p>
    </LegalPage>
  );
}
