...
export default function Page() {
  return (
    <LegalPage eyebrow="Legal" title="Terms of Service" lastUpdated="May 2026">
      ...
      <p>
        Phyla is an affiliate of iHerb. Links to iHerb products carry our rewards code. If you make a purchase after clicking, we may earn a commission — at no extra cost to you. We do not pay attention to commissions when selecting recommendations; product picks are based purely on evidence and user fit.
      </p>

      <h2>4. Intellectual Property</h2>
      <p>
        All content on Phyla — written articles, design, code, recommendation logic — is the property of Phyla or its licensors. You may share excerpts (with attribution) but may not reproduce articles in full without permission.
      </p>
      ...
      <p>
        These Terms are governed by the laws of the jurisdiction where Phyla is operated. Any disputes shall be resolved in the appropriate courts of that jurisdiction.
      </p>

      <h2>9. Contact</h2>
      <p>
        Questions about these Terms: <a href="mailto:hello@phyla.studio">hello@phyla.studio</a>
      </p>
    </LegalPage>
  );
}
