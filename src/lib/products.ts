...
export const PRODUCTS: Record<string, ProductOption[]> = {
  ...
  beetroot: [{
    ...
    imageUrls: ["https://cloudinary.images-iherb.com/image/upload/f_auto,q_auto:eco/images/amx/amx22787/v/53.jpg"],
    form: "Powder",
  ...
  phosphatidylcholine: [{
    ...
    imageUrls: ["https://cloudinary.images-iherb.com/image/upload/f_auto,q_auto:eco/images/now/now00470/v/82.jpg","https://cloudinary.images-iherb.com/image/upload/f_auto,q_auto:eco/images/now/now00470/v/87.jpg"],
    form: "Liquid Oil",
