...
export const POSTS: BlogPost[] = [
  ...
  },
  {
    ...
    title: "suppdoc.io vs my-stack.ai: An Honest Comparison",
    excerpt: "Two AI supplement recommendation tools — how they actually differ on library depth, transparency, affiliate model, and personalisation.",
    description: "suppdoc.io vs my-stack.ai head-to-head: features, supplement library, quiz depth, affiliate model, pricing, and which is better for your needs.",
    keywords: "suppdoc.io vs my-stack.ai, ai supplement recommendation, supplement quiz comparison, my-stack alternative",
    author: "suppdoc Editorial", date: "2026-05-25", readTime: "6 min", category: "Guides",
    coverBg: "linear-gradient(135deg, #5ba373 0%, #3f7a52 100%)", coverGlyph: "⚖", coverInk: "#fbf6ec",
    content: () =>
      r(React.Fragment, null,
        P("AI-powered supplement recommendation tools have multiplied in the last two years. ", Strong("my-stack.ai"), " is one of the more polished entrants, and we — ", Strong("suppdoc.io"), " — are another. This is an honest, side-by-side comparison written from inside one of the products. We'll point out where each tool genuinely excels, and where each falls short."),
        H2("At a glance"),
        Table([
          ["Feature", "suppdoc.io", "my-stack.ai"],
          ["Ingredient library", "100+ supplements with deep guides", "Curated library (smaller)"],
          ["Quiz depth", "10 questions, ~3 min", "Quiz-based"],
          ["Pre-made stacks", "11 (Foundation, Sleep, Energy, Focus, Stress, Recovery, Immunity, Vegan, Longevity, Hormonal, Beauty)", "Curated stacks"],
          ["Per-ingredient guides", "100 SEO-optimised pages with evidence, dosage, safety", "Available"],
          ["Per-product detail pages", "100 with multi-image gallery, hover zoom, certifications", "Standard"],
          ["Affiliate model", "iHerb + Amazon (both visible)", "Affiliate-based"],
          ["Cost to user", "Free", "Free"],
          ["Schema.org SEO markup", "Yes (rich Google snippets)", "Unknown"],
          ["Open Graph images", "Auto-generated per page", "Standard"],
          ["Sign-in", "Magic link + Google", "Required"],
        ]),
        H2("Where suppdoc.io has clear advantages"),
        H3("1. Library depth + SEO content per ingredient"),
        P("Every ingredient on suppdoc.io has a dedicated page (e.g. ", A("/ingredients/nac", "/ingredients/nac"), ", ", A("/ingredients/berberine", "/ingredients/berberine"), ", ", A("/ingredients/melatonin", "/ingredients/melatonin"), ") with a 120-word evidence-based description, dose, timing, safety warnings, related stacks, and direct buy links. This depth makes the library genuinely useful as a reference, not just a quiz result."),
        H3("2. Multi-affiliate transparency"),
        P("suppdoc.io shows both iHerb and Amazon buy buttons side-by-side for every supplement, letting users choose the retailer they prefer. Most competitor sites lock you into one affiliate partner, which suggests a profit-first approach. We chose dual-affiliate to align our incentive with finding the user the best product, not the highest commission."),
        H3("3. Per-product detail pages with image galleries"),
        P("Each of the 100 supplements has a dedicated ", Em("/products/[id]"), " page with hover-zoom image gallery, full certifications list, serving facts, brand background, and dual buy buttons. This matches the e-commerce experience users expect when researching a purchase."),
        H3("4. SEO-first architecture"),
        P("Every product card uses schema.org Product microdata (name, brand, aggregateRating, offers, price). Combined with auto-generated Open Graph images per page, this means suppdoc.io content appears in Google search with star ratings, price snippets, and rich preview cards on social media — boosting organic discoverability."),
        H2("Where my-stack.ai may have advantages"),
        P("We don't have full visibility into my-stack.ai's product, so we can only speak to general impressions:"),
        UL(
          "More polished onboarding visual design in places",
          "Possibly more interactive UI elements (animations, AI chat)",
          "Potentially personalised dashboards for tracking over time (suppdoc.io's /me dashboard is on the roadmap)",
        ),
        H2("Pricing"),
        P("Both tools are free for end users. Both monetise through affiliate commissions when users purchase recommended supplements. ", Strong("Neither charges a subscription."), " The difference is which retailers they partner with."),
        H2("Who should use which?"),
        P("Choose ", Strong("suppdoc.io"), " if you:"),
        UL(
          "Want a deep, browseable ingredient encyclopedia",
          "Prefer choosing between iHerb and Amazon",
          "Care about evidence transparency (dose, evidence quality, safety warnings on every supplement)",
          "Want pre-made stacks as a starting point, not just a quiz output",
          "Live outside the US and want a tool that's globally accessible (iHerb ships worldwide)",
        ),
        P("Try ", Strong("my-stack.ai"), " if you:"),
        UL(
          "Prefer their specific quiz approach",
          "Like their visual style better",
        ),
        H2("Why we built suppdoc.io"),
        P("Most supplement advice is either too vague (\"take a multivitamin\") or too aggressive (proprietary blends with unverifiable dose). We wanted a tool that respects users enough to show them: ", Em("what's in their stack, why, how much, when, and where to buy it at the best price"), " — and that uses real published evidence to make those choices."),
        P("If you compare us with any other recommendation tool — including my-stack.ai — and we don't measure up on the things that matter to you, please email us at hello@suppdoc.io. We're built to evolve."),
        CTA()
      ),
  },
  {
