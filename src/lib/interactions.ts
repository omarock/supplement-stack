...
export const INTERACTIONS: Interaction[] = [
  ...
  { a: "panax-ginseng", b: "rhodiola", kind: "caution", evidence: "moderate", summary: "Overlapping stimulant adaptogens.", detail: "Both panax ginseng and rhodiola are stimulating adaptogens, so stacking them tends to dilute the distinct benefit of each and can disturb sleep or cause overstimulation, especially at higher doses or later in the day.", advice: "Pick one for your goal, or clearly separate them from bedtime by taking the pair in the morning. Start low and reassess after a couple of weeks." },
