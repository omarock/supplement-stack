...
export const COMPETITORS: Competitor[] = [
  {
    ...
    bottomLine: "my-stack.ai pioneered the AI supplement quiz format and has a polished chat experience. suppdoc.io has a deeper ingredient library (200+ vs ~100), adds the unique 'Audit My Stack' tool for people who already take supplements, and has more honest positioning, no fabricated stats, no fake testimonials, no claim that supplements replace lifestyle changes.",
    rows: [
      ...
      { label: "Ingredient library", suppdoc: "200+ ingredients", competitor: "~100", winner: "suppdoc" },
...

  {
    ...
    rows: [
      ...
      { label: "Brand choice", suppdoc: "200+ ingredients, multiple brands", competitor: "Ritual only", winner: "suppdoc" },
...

  {
    ...
    rows: [
      ...
      { label: "Catalog scope", suppdoc: "200+ ingredients across brands", competitor: "Thorne SKUs only", winner: "suppdoc" },
...

  {
    ...
    rows: [
      ...
      { label: "Brand choice", suppdoc: "200+ ingredients, multiple brands", competitor: "-", winner: "suppdoc" },
...

  {
    ...
    rows: [
      ...
      { label: "Personalised supplements", suppdoc: "Yes (200+ ingredients)", competitor: "Limited own catalog", winner: "suppdoc" },
...

  {
    ...
    rows: [
      ...
      { label: "Supplement recommendations", suppdoc: "Yes (200+ ingredients, multiple brands)", competitor: "Included supplement list", winner: "suppdoc" },
...

  {
    ...
    rows: [
      ...
      { label: "Brand choice", suppdoc: "200+ ingredients, multiple brands", competitor: "Bioniq's own formula only", winner: "suppdoc" },
